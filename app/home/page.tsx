...
export default function HomePage() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#0f0f0f] pb-24 animate-pulse">
        {/* Skeleton Header */}
        <div className="bg-zinc-900/60 border-b border-zinc-850 px-6 py-4 sticky top-0 z-10">
          <div className="max-w-lg mx-auto flex items-center justify-between">
        ...
        <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
          {/* Skeleton Quote Box */}
          <div className="bg-zinc-900 rounded-2xl p-4 h-[74px] flex flex-col justify-center items-center gap-2">
            <div className="h-2.5 w-24 bg-zinc-800 rounded" />
            <div className="h-3.5 w-48 bg-zinc-800 rounded" />
          </div>

          {/* Skeleton Meals Section */}
          <div className="space-y-3">
            <div className="h-3 w-12 bg-zinc-800 rounded ml-1" />
            
            {/* 3 Meal Card Skeletons */}
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="bg-zinc-900 rounded-2xl p-4 border border-zinc-850 h-24 flex flex-col justify-between">
            ...
            {/* Action Buttons */}
            <div className="flex gap-2">
              <div className="flex-1 bg-zinc-900 rounded-2xl h-12 border border-dashed border-zinc-850" />
              <div className="flex-1 bg-zinc-900 rounded-2xl h-12 border border-dashed border-zinc-850" />
            </div>
          </div>

          {/* Skeleton Water Tracker */}
          <div className="bg-zinc-900 rounded-2xl p-4 h-24 flex flex-col justify-between">
          ...
          <div className="bg-zinc-900 rounded-2xl p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="h-14 bg-zinc-850 rounded-xl" />
              <div className="h-14 bg-zinc-850 rounded-xl" />
            </div>
          </div>
