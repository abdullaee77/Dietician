  ...
  return (
    <div className="bg-zinc-900 rounded-2xl border border-zinc-800 overflow-hidden">
      <div className="px-4 pt-4 pb-3 border-b border-zinc-800">
        ...
        <p className="text-xs text-zinc-500 mt-0.5">Check in on your food plan</p>
      </div>
              ...
              return (
                <div key={`skip-${food.name}`} className="px-4 py-3 flex items-center gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    {food.reason && (
                      <p className="text-zinc-500 text-xs truncate">{food.reason}</p>
                    )}
                  </div>
      ...
      {mustEatFoods.length > 0 && (
        <div className={skipFoods.length > 0 ? 'border-t border-zinc-800' : ''}>
          <div className="px-4 py-2 bg-green-500/5 border-b border-zinc-800">
